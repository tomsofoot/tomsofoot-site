...
function page(feature, list, labelMap, tax, active){
  ...
  + '<header class="x-topbar"><a class="x-brand tf-brand" href="/"><img class="tf-brand-mark" src="/assets/brand/logotf3.png" width="48" height="48" alt=""><span class="tf-brand-name">TomsoFoot</span></a><nav class="x-nav"><a href="/">Accueil</a><a href="/articles/" aria-current="page">Articles</a><a href="/magazine/lecteur.html">Le journal</a></nav></header>'
  + '<main class="x-main">'
