...
window.JOGADLE_PUBLIC = {
  SUPABASE_URL: "https://ywzgblinuqlrldpfmryk.supabase.co",
  // À COMPLÉTER avec la clé « anon / publishable » PUBLIQUE du projet Jogadle-Test.
  // (Clé publique destinée au navigateur — jamais la clé service_role.)
  SUPABASE_ANON_KEY: "",
};
