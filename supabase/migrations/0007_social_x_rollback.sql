-- 0007_social_x_rollback.sql  (VERSION DURCIE)
...
-- Ne touche PAS au prérequis 0000 (is_current_user_admin) qui peut servir à d'autres modules.
...
-- Les index (social_posts_unique_active_article, social_posts_due_idx, social_posts_article_idx,
-- x_oauth_state_expires_idx) sont supprimés automatiquement avec leurs tables.
