...
(function(){
  ...
  // Remplacement ponctuel des joueurs d'un jour précis (demande de l'admin). Les autres jours suivent la
  // rotation normale. 19/09/2026 : nouveaux joueurs du jour sur les 3 niveaux (Weidenfeller / Lavezzi / Diomède remplacés).
  var DAILY_OVERRIDE={'2026-09-19':{amateur:'Q59490',pro:'Q30036972',expert:'Q311925'}};
  ...
  function pickDaily(dateStr){
    var ov=DAILY_OVERRIDE[dateStr];
    if(ov){var o={};['amateur','pro','expert'].forEach(function(l){o[l]=findByQid(l,ov[l]);});if(o.amateur&&o.pro&&o.expert)return o;}
